...
async def upload_logo(
    ...
    # Validate file type
    allowed_types = ['image/jpeg', 'image/png', 'image/gif', 'image/svg+xml', 'image/x-icon', 'image/webp']
    ...
    if not setting:
        setting = Setting(key="business_logo", value=logo_url, category="general", description="Organization logo URL")
        db.add(setting)
    else:
