...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "facial_data_enrolled", sa.Boolean(), nullable=False, server_default="false"
        ),
        sa.Column(
            "biometric_template_id", postgresql.UUID(as_uuid=True), nullable=True
        ),
    ...
    op.create_index(
        op.f("ix_biometric_templates_member_id"),
        "biometric_templates",
        ["member_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_memberships_member_id"), "memberships", ["member_id"], unique=False
    )
    op.create_index(
        op.f("ix_memberships_start_date"), "memberships", ["start_date"], unique=False
    )
    op.create_index(
        op.f("ix_memberships_end_date"), "memberships", ["end_date"], unique=False
    )
    op.create_index(
        op.f("ix_memberships_status"), "memberships", ["status"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "resolution_width", sa.Integer(), nullable=False, server_default="1280"
        ),
        sa.Column(
            "resolution_height", sa.Integer(), nullable=False, server_default="720"
        ),
        sa.Column("enabled", sa.Boolean(), nullable=False, server_default="true"),
        sa.Column(
            "confidence_threshold", sa.Float(), nullable=False, server_default="0.85"
        ),
        sa.Column(
            "created_at", sa.DateTime(), nullable=False, server_default=sa.text("now()")
        ),
    ...
    op.create_index(
        op.f("ix_sales_transactions_member_id"),
        "sales_transactions",
        ["member_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_sales_transactions_transaction_date"),
        "sales_transactions",
        ["transaction_date"],
        unique=False,
    )
    op.create_index(
        op.f("ix_sales_transactions_invoice_number"),
        "sales_transactions",
        ["invoice_number"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_access_events_camera_id"), "access_events", ["camera_id"], unique=False
    )
    op.create_index(
        op.f("ix_access_events_member_id"), "access_events", ["member_id"], unique=False
    )
